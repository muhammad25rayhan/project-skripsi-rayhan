...
@section('content')
<style>
    .choice-weight-container {
        display: flex;
        align-items: flex-start;
        gap: 15px;
        margin-bottom: 15px;
    }
    .choice-weight-container .pilihan {
        flex: 1;
    }
    .choice-weight-container .weight-input {
        width: 100px;
    }
</style>
        ...
        <div class="ml-4 mr-4 mt-2">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Tambah Soal Test Baru</h4>
                </div>
                                                        ...
                                                        <tbody id="table_soal">
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <div class="choice-weight-container">
                                                                        <div style="flex: 1;">
                                                                        ...
                                                                        <div>
                                                                            <label><b>Bobot Pilihan 1</b></label>
                                                                            <input type="number" step="0.01" class="form-control mt-2 weight-input" name="data[1][weight_1]" value="0.4">
                                                                        </div>
                                                                    </div>
                                                                    <div class="choice-weight-container">
                                                                        <div style="flex: 1;">
                                                                        ...
                                                                        <div>
                                                                            <label><b>Bobot Pilihan 2</b></label>
                                                                            <input type="number" step="0.01" class="form-control mt-2 weight-input" name="data[1][weight_2]" value="0.3">
                                                                        </div>
                                                                    </div>
                                                                    <div class="choice-weight-container">
                                                                        <div style="flex: 1;">
                                                                        ...
                                                                        <div>
                                                                            <label><b>Bobot Pilihan 3</b></label>
                                                                            <input type="number" step="0.01" class="form-control mt-2 weight-input" name="data[1][weight_3]" value="0.3">
                                                                        </div>
                                                                    </div>
                                                                    <div class="choice-weight-container">
                                                                        <div style="flex: 1;">
                                                                        ...
                                                                        <div>
                                                                            <label><b>Bobot Pilihan 4</b></label>
                                                                            <input type="number" step="0.01" class="form-control mt-2 weight-input" name="data[1][weight_4]" value="0.1">
                                                                        </div>
                                                                    </div>
                                                                    <div class="choice-weight-container">
                                                                        <div style="flex: 1;">
                                                                        ...
                                                                        <div>
                                                                            <label><b>Bobot Pilihan 5</b></label>
                                                                            <input type="number" step="0.01" class="form-control mt-2 weight-input" name="data[1][weight_5]" value="0.3">
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
    ...
    var fieldHtml = `<tr><td>
                        <label><b>Soal</b></label>
                                    ...
                                    <div class="choice-weight-container">
                                        ...
                                        <div>
                                            <label><b>Bobot Pilihan 1</b></label>
                                            <input type="number" step="0.01" class="form-control mt-2 weight-input" name="data[${x}][weight_1]" value="0.1">
                                        </div>
                                    </div>
                                    <div class="choice-weight-container">
                                        <div style="flex: 1;">
                                        ...
                                        <div>
                                            <label><b>Bobot Pilihan 2</b></label>
                                            <input type="number" step="0.01" class="form-control mt-2 weight-input" name="data[${x}][weight_2]" value="0.2">
                                        </div>
                                    </div>
                                    <div class="choice-weight-container">
                                        <div style="flex: 1;">
                                        ...
                                        <div>
                                            <label><b>Bobot Pilihan 3</b></label>
                                            <input type="number" step="0.01" class="form-control mt-2 weight-input" name="data[${x}][weight_3]" value="0.3">
                                        </div>
                                    </div>
                                    <div class="choice-weight-container">
                                        <div style="flex: 1;">
                                        ...
                                        <div>
                                            <label><b>Bobot Pilihan 4</b></label>
                                            <input type="number" step="0.01" class="form-control mt-2 weight-input" name="data[${x}][weight_4]" value="0.4">
                                        </div>
                                    </div>
                                    <div class="choice-weight-container">
                                        <div style="flex: 1;">
                                        ...
                                        <div>
                                            <label><b>Bobot Pilihan 5</b></label>
                                            <input type="number" step="0.01" class="form-control mt-2 weight-input" name="data[${x}][weight_5]" value="0.5">
                                        </div>
                                    </div>
                                    <a href="javascript:void(0)" class="btn icon icon-left btn-danger mt-2 btn-delete"><i
