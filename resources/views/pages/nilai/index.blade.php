...
@section('content')
    ...
    render: function (data, type, row) {
        let nilai = parseInt(data);
        let kategori = '';

        if (nilai >= 0 && nilai <= 25) {
            kategori = 'Normal';
        } else if (nilai >= 26 && nilai <= 49) {
            kategori = 'Keterlibatan Dengan Pornografi';
        } else if (nilai >= 50 && nilai <= 69) {
            kategori = 'Muncul Kecanduan Pornografi';
        } else if (nilai >= 70 && nilai <= 100) {
            kategori = 'Kecanduan Pornografi ';
        } else {
            kategori = '-';
        }
