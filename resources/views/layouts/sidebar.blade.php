<div id="sidebar" class='active'>
    <div class="sidebar-wrapper active">
        ...
        <p class="mt-4">
        <h1 class="text-center"><b>CBT-PAST</b></h1>
        </p>
            ...
            <ul class="menu">
                ...
                <li class="sidebar-item {{ $page == 'sesi' ? 'active' : '' }}  has-sub">
                    ...
                    <ul class="submenu {{ $page == 'sesi' ? 'active' : '' }}">
                        @can('sesi-list')
                        <li>
                            <a href="{{ route('exam-session.index') }}">List Sesi Test</a>
                        </li>
                        @endcan
                        @can('sesi-create')
                        <li>
                            <a href="{{ route('exam-session.create') }}">Tambah Sesi Test</a>
                        </li>
                        @endcan
                    </ul>
                </li>
                ...
                <li class="sidebar-item {{ $page == 'question' ? 'active' : '' }} has-sub">
                    ...
                    <ul class="submenu {{ $page == 'question' ? 'active' : '' }}">
                        @can('soal-list')
                        <li>
                            <a href="{{ route('question.index') }}">List Soal Test</a>
                        </li>
                        @endcan
                        @can('soal-create')
                        <li>
                            <a href="{{ route('question.create') }}">Tambah Soal Test</a>
                        </li>
                        @endcan
                    </ul>
                </li>
                ...
                <li class="sidebar-item {{ $page == 'exam' ? 'active' : '' }}  has-sub">
                    ...
                    <ul class="submenu {{ $page == 'exam' ? 'active' : '' }}">
                        @can('ujian-list')
                        <li>
                            <a href="{{ route('exam.index') }}">List Test</a>
                        </li>
                        @endcan
                        @can('ujian-create')
                        <li>
                            <a href="{{ route('exam.create') }}">Tambah Test</a>
                        </li>
                        @endcan
                    </ul>
